...
from plot_trajectory import render_path_spiral
...
def reconstruct():
    ...
    # todo to visualize better cam2wld transform in the point clouds and draw the trajectory and camera frames

    rgbd = o3d.geometry.RGBDImage.create_from_color_and_depth(img, depth)
    pcd = o3d.geometry.PointCloud.create_from_rgbd_image(rgbd, intrinsic)

    cam_poses = gt_poses()
    cam_pose = o3d.geometry.TriangleMesh.create_coordinate_frame(0.005, cam_poses[0][:,3])
    np_colors = []
    ...
    o3d.visualization.draw_geometries([pcd, cam_pose])
